"""
Architecture of KonCept512 model.
...
def inceptionresnetv2(
    num_classes=1000,
    pretrained="imagenet",
    ckpt_pth="checkpoints/inceptionresnetv2-520b38e4.pth",
):
...
class model_qa(nn.Module):
    def __init__(self, num_classes, ckpt_pth, **kwargs):
        super(model_qa, self).__init__()
        base_model = inceptionresnetv2(
            num_classes=1000, pretrained="imagenet", ckpt_pth=ckpt_pth
        )
